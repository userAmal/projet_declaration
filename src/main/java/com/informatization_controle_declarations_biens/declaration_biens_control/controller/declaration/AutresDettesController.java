...
public class AutresDettesController {
    ...
    public ResponseEntity<FileUploadResponse> uploadFile(
        ...
        AutresDettes entity = service.findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND,
                        "Dette ID " + id + " introuvable"));
        ...
        try {
            ...
            String downloadUri = ServletUriComponentsBuilder.fromCurrentContextPath()
                    .path("/api/autres-dettes/download/")
                    .path(id.toString())
                    .toUriString();
...
// Dans AutresDettesController.java
@GetMapping("/by-creancier/{creancierId}")
public ResponseEntity<List<AutresDettesProjection>> getByCreancier(@PathVariable Long creancierId) {
    List<AutresDettesProjection> dettes = service.findByCreancier(creancierId);
